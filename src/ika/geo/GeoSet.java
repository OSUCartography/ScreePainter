...
public class GeoSet extends GeoObject implements Serializable, Cloneable {
    ...
    /**
     * Deslect all GeoObjects contained in this GeoSet and insert the passed
     * GeoObject. The object will be inserted after all currently contained
     * GeoObjects.
     */
    public void deselectAndAdd(GeoObject geoObject) {

        setSelected(false);
        add(this.vector.size(), geoObject);
    }

    /**
     * Deslect all GeoObjects contained in this GeoSet and insert the children
     ...
     */
    public void deselectAndAddChildren(GeoSet geoSet) {
     ...
     * @param geoObject The GeoObject to add.
     */
    public void add(int index, GeoObject geoObject) {
        if (geoObject == null) {
            return;
        }
     ...
     */
    public void replaceGeoObject(GeoObject newGeoObject,
     ...
     */
    public void replaceGeoObject(GeoObject newGeoObject, int index) {
     ...
     */
    public void replaceGeoObject(GeoObject newGeoObject, String name) {
     ...
     */
    public void replaceGeoObjects(GeoSet geoSet) {
     ...
     */
    public GeoObject remove(int index) {
     ...
     * @return The number of GeoSets contained by this GeoSet.
     */
    public int getNumberOfSubSetsInTree() {
        int numberOfSubSets = 0;
        java.util.Iterator iterator = this.vector.iterator();
        while (iterator.hasNext()) {
    ...
    public Object[] getGeoObjectsAsArray() {
     ...
     * unique.
     */
    public GeoObject getGeoObjectByID(long id) {
        java.util.Iterator iterator = this.vector.iterator();
        while (iterator.hasNext()) {
            GeoObject geoObject = (GeoObject) iterator.next();
     ...
     */
    public int getIndexOfGeoObject(Object obj) {
        if (obj == null) {
            return -1;
        }
     ...
     */
    private GeoObject searchSingleSelectedGeoObject(
     ...
     * object.
     */
    public GeoObject getSingleSelectedGeoObject(boolean searchChildren) {
     ...
     */
    public void getAllGeoObjects(Class cl,
     ...
     */
    public GeoObject getFirstGeoObject(Class requiredClass,
     ...
     */
    public boolean transformSelected(
     ...
     */
    public boolean deformSelected(Rectangle2D newBounds) {
