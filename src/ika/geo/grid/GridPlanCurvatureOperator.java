 ...
 * @author jenny
 */
public class GridPlanCurvatureOperator implements GridOperator{
    /*
    public static void main(String [] ars) {
        try {
            GeoGrid grid = ika.geoimportESRIASCIIGridReader.read("/Users/jenny/Desktop/half_filtered.asc");
            grid = new GridPlanCurvatureOperator().operate(grid);
            System.out.println(grid.toStringWithStatistics());
            new ika.geoexport.ESRIASCIIGridExporter().export(grid, "/Users/jenny/Desktop/plancurvature.asc");
