...
public class FileUtils {
     ...
     * removed. The file is trimmed in any case (i.e. leading and trailing
    ...
    public static String forceFileNameExtension(String fileName, String ext) {
        ...
        // test if the file has the required extension
        if (!fileNameLower.endsWith("." + extLower)) {

            // file has wrong extension: add an extension
    ...
    public static String askFile(final java.awt.Frame frame, final String message,
        ...
        // make sure we run in the event dispatching thread.
