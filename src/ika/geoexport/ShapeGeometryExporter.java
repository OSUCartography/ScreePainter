...
public class ShapeGeometryExporter extends GeoSetExporter{
    ...
    throws IOException {
        ...
        Rectangle2D bbox = geoSet.getBounds2D(GeoObject.UNDEFINED_SCALE);
    ...
    throws IOException {
        ...
        geoPath = geoPath.toFlattenedPath(this.bezierConversionTolerance);
     ...
     * based on the class of the first GeoObject found in the passed GeoSet.
     */
