 ...
 * It does not write a GeoGrid or another object modelling a grid, but is used 
 ...
 */
public class ESRIASCIIGridWriter {
     ...
     * be different from the noDataValue paramater passed in the constructor.
     */
