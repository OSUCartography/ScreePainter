...
public class PageFormat implements Cloneable, Serializable {
    ...
    /**
     * A factor to convert from millimeter to pixels. Assumes 72 pixels per inch.
     */
    ...
    /**
     * If true, the page width and height are in pixels, otherwise in millimeter.
     */
    ...
    /**
     * Custom deserialization to initialize the vector of PageFormatChangeListeners.
     */
    ...
    /**
     * Returns the page scale. If the user enters "1:100,000", the page scale
     * is 100,000.
     */
    ...
    /**
     * Sets the page scale. If the user enters "1:100,000", the page scale
     * is 100,000
     */
    ...
    public Rectangle2D getPageSizeWorldCoordinates() {
        ...
        final double w = this.getPageWidthWorldCoordinates();
        final double h = this.getPageHeightWorldCoordinates();
        Rectangle2D worldPageSize = new Rectangle2D.Double(
                this.pageLeft, this.pageBottom, w, h);
        return worldPageSize;
    }

    /**
     * Returns true if the page size is defined in pixels, fals if it is 
    ...
    /**
     * Returns true if the page size is defined in millimeter, fals if it is 
     * defined in pixels.
     */
    ...
    /**
     * Adusts the position and dimension of the page to include the passed 
     * rectangle. Uses the current pageScale to compute a height and width 
     * in pixels or mm.
     * @param bounds
     */
    ...
    public String toString() {
        ...
        sb.append(" Left: " + this.pageLeft);
        sb.append(" Bottom: " + this.pageBottom);
        sb.append(" Scale: " + this.pageScale);
        sb.append(" Width: " + this.pageWidth);
        sb.append(" Height: " + this.pageHeight);
        sb.append(" Automatic: " + this.automatic);
        sb.append(" Show: " + this.visible);
        return sb.toString();
    }
}
