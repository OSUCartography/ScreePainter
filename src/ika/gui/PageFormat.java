...
public class PageFormat implements Cloneable, Serializable {
     ...
     */
    public final void addPageFormatChangeListener(
     ...
     */
    public final void removePageFormatChangeListener(
            PageFormatChangeListener listener) {
    ...
    /**
     * Returns true if the page size is defined in pixels, fals if it is defined
     * in millimeter.
     */
