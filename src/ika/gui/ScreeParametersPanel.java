...
public class ScreeParametersPanel extends javax.swing.JPanel {
    ...
    protected void writeGUI() {
        ...
        try {
            ...
            // from the dem
            updateEnableStateOfGullyLineGUI();
    ...
    private void updateEnableStateOfGullyLineGUI() {
        Component[] com = linePanel.getComponents();
        for (int a = 0; a < com.length; a++) {
            if (com[a] != extractGullyLinesCheckBox) {
                com[a].setEnabled(!screeData.fixedScreeLines && extractGullyLinesCheckBox.isSelected());
            }
        }
    }
    ...
    private void initComponents() {
        ...
        extractGullyLinesCheckBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                extractGullyLinesCheckBoxActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridwidth = 3;
...
private void densityHelpButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_densityHelpButtonActionPerformed
    ...
    private void extractGullyLinesCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_extractGullyLinesCheckBoxActionPerformed
        updateEnableStateOfGullyLineGUI();
    }//GEN-LAST:event_extractGullyLinesCheckBoxActionPerformed
