 ...
 */
public abstract class SwingWorkerWithProgressIndicatorOld<T, V> extends SwingWorker<T, V>
     ...
     * @param blockOwner
     */
    public SwingWorkerWithProgressIndicatorOld(ScreeWindow owner,
            String dialogTitle,
            String message,
            boolean blockOwner) {
    ...
    private void initDialog(ScreeWindow owner,
            String dialogTitle,
            String message,
            boolean blockOwner) {
