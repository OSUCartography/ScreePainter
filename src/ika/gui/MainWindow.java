...
public abstract class MainWindow extends javax.swing.JFrame
    ...
    /**
     * file path to location on the hard disk where this document is stored. It
     * is null if the document has never been saved.
     */
     ...
     */
    protected java.awt.Dimension packedSize = null;
    ...
    /**
     * Creates a new document window. Automatically assigns a title, and adds
     * the new window to the menu listing all currently open windows. The new
    ...
    /**
     * This method is called after the constructor. Data models and the GUI
     ...
     * @throws Exception An exception is thrown if the passed data cannot be
     * used to set the data of the document.
     */
     ...
     * file, where the property is called "MainWindow". This method only calls
     * window.init() when told to do so.
     *
    ...
    /**
     * Asks the user to select a file and opens a new window and initializes its
     * contents with the selected file.
     *
    ...
    /**
     * Closes this window. Asks the user whether to save or discard changes if
     * necessary, and saves the document to a file if necessary.
     *
    ...
    protected boolean closeDocumentWindow() {
        ...
        if (MainWindow.windows.isEmpty() && !ika.utils.Sys.isMacOSX()) {
        ...
        System.out.println("nbr windows " + MainWindow.windows.size());
        System.out.println(" Mac " + ika.utils.Sys.isMacOSX());
        return true;
    }

    /**
     * Closes all currently open document windows that are stored in
     * this.windows vector. Asks the user for a location to store the document
     * if it has not been saved yet. Stops closing windows when the user
     * cancels.
     *
    ...
    /**
     * Sets the dirty flag of this window. This indicates that the documents
     * must be saved before it can be closed.
     */
