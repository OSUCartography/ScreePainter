...
public class GeoExportGUI {
        ...
        try {
            ...
            if (exporter instanceof VectorGraphicsExporter) {
                ...
                try {
                    ...
                    ErrorDialog.showErrorDialog("Please enter a valid number for the image width.", "", null, frame);
                    return;
                }
            }
    ...
    private static final String[] orderedExporterNames;
    private static final String[] exporterNames = {"SVG", "Illustrator", "PDF", "GeospatialPDF", "TerraGoGeoPDF", "Shape", "DXF", "Ungenerate", "PNG", "JPEG"};
    ...
    static {
        ...
        orderedExporterNames = exporterMap.keySet().toArray(new String[]{});
