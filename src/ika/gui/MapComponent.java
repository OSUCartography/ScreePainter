...
public class MapComponent extends javax.swing.JComponent
    ...
    public void showAll() {
        ...
        Rectangle2D box = this.root.getBounds2D(
    ...
    /**
     * Change the affine transformation of a graphics destination for drawing
     * of world coordinates, i.e. coordinates of the map objects.
